...
const Color darkGreyClr = Color(0xFF2D2C2C); //0xFF121212
const Color backDarkClr = Color(0xFF333742);
const Color cardItemDarkClr = Color(0xFF454D5A);
